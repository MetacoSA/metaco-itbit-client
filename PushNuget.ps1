...
del *.nupkg
C:\Windows\Microsoft.NET\Framework\v4.0.30319\msbuild.exe ".\ItBitClient\ItBitClient.csproj" -p:Configuration=Release


.\.nuget\NuGet.exe pack .\ItBitClient\ItBitClient.csproj -Prop Configuration=Release
